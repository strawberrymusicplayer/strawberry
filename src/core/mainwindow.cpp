...
MainWindow::MainWindow(Application *app,
  ...
  ui_->action_last_playlist->setShortcut(QKeySequence::fromString(u"Ctrl+End"_s));
  ui_->action_active_playlist->setShortcut(QKeySequence::fromString(u"Ctrl+Home"_s));
  ui_->action_close_playlist->setShortcut(QKeySequence::fromString(u"Ctrl+C"_s));
