...
class JsonBaseRequest : public HttpBaseRequest {
 ...
 protected:
  virtual JsonObjectResult ParseJsonObject(const QByteArray &data);
  virtual JsonObjectResult ParseJsonObject(QNetworkReply *reply);
  virtual JsonValueResult GetJsonValue(const QJsonObject &json_object, const QString &name);
  virtual JsonObjectResult GetJsonObject(const QJsonObject &json_object, const QString &name);
  virtual JsonArrayResult GetJsonArray(const QJsonObject &json_object, const QString &name);
};
