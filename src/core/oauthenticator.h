...
class OAuthenticator : public QObject {
 ...
 public:
  ...
  void set_authorization_header(const bool authorization_header);
 ...
 private:
  ...
  void RequestAccessToken(const QString &code, const QUrl &redirect_url);
