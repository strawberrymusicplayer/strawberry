...
CollectionSettingsPage::CollectionSettingsPage(SettingsDialog *dialog,
  ...
  ui_->combobox_sort->setItemData(0, static_cast<int>(SortShowArtists::AsIs));
  ui_->combobox_sort->setItemData(1, static_cast<int>(SortShowArtists::SortSkipArticleShowArtist));
  ui_->combobox_sort->setItemData(2, static_cast<int>(SortShowArtists::SortByTagShowArtist));
  ui_->combobox_sort->setItemData(3, static_cast<int>(SortShowArtists::SortByTagShowTag));
...
void CollectionSettingsPage::Load() {
  ...
  ui_->combobox_sort->setCurrentIndex(ui_->combobox_sort->findData(s.value(kMenuSortArtists, static_cast<int>(SortShowArtists::SortSkipArticleShowArtist)).toInt()));
...
void CollectionSettingsPage::Save() {
  ...
  const SortShowArtists menu_sort = static_cast<SortShowArtists>(ui_->combobox_sort->currentData().toInt());
  s.setValue(kMenuSortArtists, static_cast<int>(menu_sort));
