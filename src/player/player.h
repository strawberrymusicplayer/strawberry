...
class Player : public PlayerInterface {
 ...
 public:
  explicit Player(SharedPtr<TaskManager> task_manager, SharedPtr<UrlHandlers> url_handlers, SharedPtr<PlaylistManager> playlist_manager, QObject *parent = nullptr);
 ...
 private Q_SLOTS:
  void UrlHandlerRegistered(UrlHandler *url_handler);
