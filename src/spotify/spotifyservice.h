...
class SpotifyService : public StreamingService {
 ...
 public:
  ...
  bool authenticated() const override { return !access_token().isEmpty(); }
 ...
 private:
  ...
  QScopedPointer<SpotifyRequest, QScopedPointerDeleteLater> artists_request_;
  QScopedPointer<SpotifyRequest, QScopedPointerDeleteLater> albums_request_;
  QScopedPointer<SpotifyRequest, QScopedPointerDeleteLater> songs_request_;
  QScopedPointer<SpotifyRequest, QScopedPointerDeleteLater> search_request_;
