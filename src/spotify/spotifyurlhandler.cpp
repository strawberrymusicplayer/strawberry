...
SpotifyUrlHandler::SpotifyUrlHandler(const SharedPtr<TaskManager> task_manager, SpotifyService *service)
    : UrlHandler(service),
      task_manager_(task_manager),
      service_(service) {

  QObject::connect(service, &SpotifyService::StreamURLFailure, this, &SpotifyUrlHandler::GetStreamURLFailure);
  QObject::connect(service, &SpotifyService::StreamURLSuccess, this, &SpotifyUrlHandler::GetStreamURLSuccess);

}

QString SpotifyUrlHandler::scheme() const {
...
void SpotifyUrlHandler::GetStreamURLFailure(const uint id, const QUrl &media_url, const QString &error) {
...
void SpotifyUrlHandler::GetStreamURLSuccess(const uint id, const QUrl &media_url, const QUrl &stream_url, const Song::FileType filetype, const int samplerate, const int bit_depth, const qint64 duration) {
...
void SpotifyUrlHandler::CancelTask(const int task_id) {
