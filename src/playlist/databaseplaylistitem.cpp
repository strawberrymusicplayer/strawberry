...
#include "databaseplaylistitem.h"
#include "tagreader/tagreaderclient.h"

class SqlRow;

DatabasePlaylistItem::DatabasePlaylistItem(const Song::Source source) : PlaylistItem(source) {
  song_.set_source(source);
}

DatabasePlaylistItem::DatabasePlaylistItem(const Song &song) : PlaylistItem(song.source()), song_(song) {}

QUrl DatabasePlaylistItem::Url() const { return song_.url(); }

bool DatabasePlaylistItem::InitFromQuery(const SqlRow &query) {
...
void DatabasePlaylistItem::Reload() {
...
QVariant DatabasePlaylistItem::DatabaseValue(const DatabaseColumn database_column) const {
...
Song DatabasePlaylistItem::Metadata() const {
...
void DatabasePlaylistItem::SetArtManual(const QUrl &cover_url) {
