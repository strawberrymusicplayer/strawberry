...
void SmartPlaylistSearchPreview::Init(SharedPtr<Player> player,
  ...
  model_ = new Playlist(nullptr, nullptr, nullptr, nullptr, collection_backend_, -1, QString(), false, this);
