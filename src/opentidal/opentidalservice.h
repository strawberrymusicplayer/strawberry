...
#ifndef OPENTIDALSERVICE_H
#define OPENTIDALSERVICE_H
...
class OpenTidalRequest;
class OpenTidalFavoriteRequest;
class OpenTidalStreamURLRequest;
...
class OpenTidalService : public StreamingService {
  Q_OBJECT

 public:
  explicit OpenTidalService(const SharedPtr<TaskManager> task_manager,
  ...
  OpenTidalSettings::ManifestType manifest_type() const { return manifest_type_; }
  OpenTidalSettings::UriScheme uri_scheme() const { return uri_scheme_; }
 ...
 private:
  ...
  OpenTidalRequestPtr artists_request_;
  OpenTidalRequestPtr albums_request_;
  OpenTidalRequestPtr songs_request_;
  OpenTidalRequestPtr search_request_;
  OpenTidalFavoriteRequest *favorite_request_;

  bool enabled_;
  //QString client_id_;
  OpenTidalSettings::UriScheme uri_scheme_;
  OpenTidalSettings::ManifestType manifest_type_;
  QString format_;
  ...
  QMap<uint, OpenTidalStreamURLRequestPtr> stream_url_requests_;

  QList<QObject*> wait_for_exit_;
};

using OpenTidalServicePtr = SharedPtr<OpenTidalService>;

#endif  // OPENTIDALSERVICE_H
