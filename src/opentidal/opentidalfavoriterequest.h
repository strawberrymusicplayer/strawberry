...
#ifndef OPENTIDALFAVORITEREQUEST_H
#define OPENTIDALFAVORITEREQUEST_H
...
class OpenTidalFavoriteRequest : public OpenTidalBaseRequest {
  Q_OBJECT

 public:
  explicit OpenTidalFavoriteRequest(OpenTidalService *service, const SharedPtr<NetworkAccessManager> network, QObject *parent = nullptr);
 ...
 private Q_SLOTS:
  void AddFavoritesReply(QNetworkReply *reply, const OpenTidalFavoriteRequest::FavoriteType type, const SongList &songs);
  void RemoveFavoritesReply(QNetworkReply *reply, const OpenTidalFavoriteRequest::FavoriteType type, const SongList &songs);
...
#endif  // OPENTIDALFAVORITEREQUEST_H
