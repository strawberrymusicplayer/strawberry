...
#ifndef OPENTIDALURLHANDLER_H
#define OPENTIDALURLHANDLER_H
...
class OpenTidalUrlHandler : public UrlHandler {
  Q_OBJECT

 public:
  explicit OpenTidalUrlHandler(const SharedPtr<TaskManager> task_manager, OpenTidalService *service);
