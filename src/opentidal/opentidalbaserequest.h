...
#ifndef OPENTIDALBASEREQUEST_H
#define OPENTIDALBASEREQUEST_H
...
class OpenTidalBaseRequest : public JsonBaseRequest {
  Q_OBJECT

 public:
  explicit OpenTidalBaseRequest(OpenTidalService *service, const SharedPtr<NetworkAccessManager> network, QObject *parent = nullptr);
