...
class RadioModel : public SimpleTreeModel<RadioItem> {
 ...
 public:
  explicit RadioModel(SharedPtr<AlbumCoverLoader> album_cover_loader, SharedPtr<RadioServices> radio_services, QObject *parent = nullptr);
  ~RadioModel() override;
 ...
 private:
  ...
  SharedPtr<RadioServices> radio_services_;
