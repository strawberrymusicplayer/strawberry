...
QobuzRequest::QobuzRequest(QobuzService *service, QobuzUrlHandler *url_handler, SharedPtr<NetworkAccessManager> network, const Type query_type, QObject *parent)
